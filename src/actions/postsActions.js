...
// getPostsFailure informing Redux that an error was encountered during Redux on failed API call

// Create action creators, which are funcitons that return an action.
